...
- (void)setupUI
{
    ...
    // Round switch view
    self.thumbView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width/2-kHorizontalAdjustment, self.frame.size.height-kHorizontalAdjustment)];
	...
	// SMBox customization
	[self setOnTintColor:[UIColor colorWithWhite:0.57647058823529f alpha:1.0f]];
	[self setTintColor:[UIColor colorWithWhite:0.57647058823529f alpha:1.0f]];
	[self setThumbTintColor:[UIColor colorWithRed:0.08235294117647f green:0.42352941176471f blue:0.68627450980392f alpha:1.0f]];
	[self setShape:kNKColorSwitchShapeRectangleNoCorner];
}
