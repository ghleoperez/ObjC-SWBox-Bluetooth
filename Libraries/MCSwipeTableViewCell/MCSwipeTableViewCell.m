...
- (void)setDragElement:(UIView *)dragElement
{
	[dragElement addGestureRecognizer:_panGestureRecognizer];
}
...
- (void)handlePanGestureRecognizer:(UIPanGestureRecognizer *)gesture {
    ...
    if (state == UIGestureRecognizerStateBegan || state == UIGestureRecognizerStateChanged) {
        ...
        CGPoint center = CGPointMake(_contentScreenshotView.center.x + translation.x, _contentScreenshotView.center.y);
