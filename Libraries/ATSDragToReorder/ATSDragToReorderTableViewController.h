...
@interface ATSDragToReorderTableViewController : NSObject <UIGestureRecognizerDelegate, ATSDragToReorderTableViewControllerDraggableIndicators>  {
@protected
...
@property (assign) CGRect touchArea;
